'''
Only Add SubTitle
python e2e_video_add_subtitles_v2.py --source /home/k100/develop/whisperTorch/samples/1005智慧照護住民安全辨識輔助系統影片.mp4 --modelType medium

Add SubTitle with translate
python e2e_video_add_subtitles_v2.py --source /home/k100/develop/whisperTorch/samples/VTS_01_2.mp4 --modelType medium --langFrom ja --langTo zh-TW
...
if args.langTo is 0:
    ...
    result = model.transcribe(output_audio_file, **translate_options)
t2 = time.time()
...
for i,segment in enumerate(segments):
    ...
    if args.langTo is not 0:
        ...
        text = translate(translator,text,source_lang='en',target_lang=langTo)
